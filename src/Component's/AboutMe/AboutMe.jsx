    ...
    return (
        <div className='h-screen md:flex-row justify-center bg-[#212529]' id='aboutMe'>
            ...
            <div className='px-10 mt-20 md:flex gap-5'>
                <div data-aos="fade-right" className='text-white md:w-[65%] p-2 mb-5 md:mb-0'>
                ...
                <div data-aos="fade-left" className='text-white md:w-[35%] border-l-4 border-teal-500 p-2 space-y-4'>
