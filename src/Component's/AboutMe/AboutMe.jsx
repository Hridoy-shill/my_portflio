    ...
    return (
        <div className='h-screen md:flex-row justify-center bg-[#212529]' id='aboutMe'>
            <div className='flex-col px-32'>
                ...
                <p className='text-center text-yellow-500 md:text-4xl text-xl font-bold md:-mt-20 border-b-4 pb-3 border-yellow-500'>More About Me</p>
            </div>
            ...
            <div className='px-10 mt-20 md:flex gap-5'>
                ...
                <div className='text-white md:w-[35%] border-l-4 border-yellow-500 p-2 space-y-4'>
