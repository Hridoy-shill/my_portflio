...
const AboutMe = () => {
    ...
    return (
        <div className='h-fit md:flex-row justify-center bg-[#212529]' id='aboutMe'>
            <div className='flex-col md:px-32 px-5'>
                <h2 className='md:text-9xl text-5xl text-gray-500 text-opacity-20 font-bold md:pt-10 pt-5 md:tracking-wide text-center'>ABOUT-ME</h2>
                <p className='text-center text-teal-500 md:text-4xl text-xl font-bold md:-mt-20 -mt-9 border-b-4 pb-3 border-teal-500'>More About Me</p>
            </div>
