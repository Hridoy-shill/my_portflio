    ...
    return (
        <div className='h-screen w-full bg-[#343A40] px-10' id='myService'>
            <div className='flex-col px-32'>
                ...
                <p className='text-center text-yellow-500 text-4xl font-bold -mt-20 border-b-4 pb-3 border-yellow-500'>What I Do ?</p>
            </div>

            <div className='grid md:grid-cols-2 mt-20 gap-5'>
                <div className='text-white gap-3 flex w-[100%]'>
                    <p className='w-[25%] bg-yellow-500 p-5 rounded-lg'>
                        <FaChalkboardTeacher className='w-full h-full text-black'></FaChalkboardTeacher>
                    </p>
                    <div className='w-[75%]'>
                        <p className='font-semibold text-yellow-500 text-2xl'>Developing Front-End website</p>
                ...
                <div className='text-white gap-3 flex w-[100%]'>
                    ...
                    <div className='w-[75%]'>
                        <p className='font-semibold text-yellow-500 text-2xl'>Developing Back-End website</p>
                ...
                <div className='text-white gap-3 flex w-[100%] mt-5'>
                    ...
                    <div className='w-[75%]'>
                        <p className='font-semibold text-yellow-500 text-2xl'>Developing Full-stack website</p>
                ...
                <div className='text-white gap-3 flex w-[100%] mt-5'>
                    ...
                    <div className='w-[75%]'>
                        <p className='font-semibold text-yellow-500 text-2xl'>Bug's fixing</p>
